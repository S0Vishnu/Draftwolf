...
export const extensions: Extension[] = [
  ...
  },
  {
    id: 'dracula',
    name: 'Dracula',
    description: 'A dark, minimal theme for DraftWolf with teal accents. Easy on the eyes for long sessions.',
    kind: 'theme',
    kindLabel: 'Theme',
    repositoryUrl: 'https://github.com/sathishTSR/draftwolf-dracula-theme',
    version: 'latest',
    accentColor: '#2AAFA1',
  },
];
